...
from jenkins_weather.library.httpclient import HttpClient
...
class TestWeather:
    ...
    @pytest.mark.parametrize('city_code, exp_city', [("101280601", "深圳"), ("10104010", "重庆"), ("101010100", "北京"), ("101020100", "上海")])
